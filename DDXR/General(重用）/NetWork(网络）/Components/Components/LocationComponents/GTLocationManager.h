...
@interface GTLocationManager : GTAPIBaseManager <GTAPIManager,GTAPIManagerValidator, GTAPIManagerParamSourceDelegate, GTAPIManagerApiCallBackDelegate, CLLocationManagerDelegate>
...
@property (nonatomic, strong) GTCityListManager *cityListManager;
