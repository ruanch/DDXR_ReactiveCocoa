 ...
 *                  14/3/1             GT-ruan
 **********************************************************************
 * @文件名称: GTCityListManager.m
 * @文件描述: 无
 * @补充说明: 无
 *********************************************************************/
#import "GTCityListManager.h"
#import "GTPListManager.h"
#import "GTNetworking.h"

@interface GTCityListManager ()

@property (nonatomic, copy, readwrite) NSString *methodName;

@property (nonatomic, copy) id cityData;
@property (nonatomic, strong) GTPListManager *plistManager;

@end

@implementation GTCityListManager
...
{
    if ([manager isKindOfClass:[GTCityListManager class]]) {
...
- (GTPListManager *)plistManager
{
    if (_plistManager == nil) {
        _plistManager = [[GTPListManager alloc] init];
    }
