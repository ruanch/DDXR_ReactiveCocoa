...
- (GTCityListManager *)cityListManager
{
    if (_cityListManager == nil) {
        _cityListManager = [[GTCityListManager alloc] init];
    }
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.cityListManager = [[GTCityListManager alloc] init];
    }
    return self;
}
...
+ (instancetype)sharedInstance
{
    ...
    static GTLocationManager *sharedInstance = nil;
    dispatch_once(&AJKHDLocationManagerOnceToken, ^{
        sharedInstance = [[GTLocationManager alloc] init];
...
- (void)switchToCityWithCityId:(NSString *)cityId
{
    ...
    NSDictionary *cityInfo = @{@"cityId":[GTLocationManager sharedInstance].currentCityId, @"cityName":[GTLocationManager sharedInstance].currentCityName};
    [[GTLocationManager sharedInstance].cityListManager saveCityToPlistWithData:cityInfo];
...
{
    NSDictionary *cityInfo = [[GTLocationManager sharedInstance].cityListManager loadCurrentCityDataFromPlist];
    self.isUsingLocatedData = NO;
