...
@interface DDNoticeViewController ()
...
-(MyLinearLayout*)createVertSubviewLayout
{
    ...
    UILabel *v1 = [self createLabel:NSLocalizedString(@"left margin1111111111113231232131231231231231231231231231231231231231231231234324234234234234234324234234234234234234", @"") backgroundColor:[CFTool color:5]];
    v1.myTopMargin = 10;  //上边边距10
    v1.myLeftMargin = 10; //左边边距10
    v1.myWidth = 200;
    v1.myHeight = 35;     //设置布局尺寸
    v1.flexedHeight = YES;
    v1.textAlignment = NSTextAlignmentLeft;

    [vertLayout addSubview:v1];

    
    UILabel *v2 = [self createLabel:NSLocalizedString(@"horz center1231232131232132312312321311123123123123777777744444447555555556666666234234234234234234324234234324234234234", @"") backgroundColor:[CFTool color:6]];
    v2.myTopMargin = 10;
    v2.myCenterXOffset = 0;            //水平居中,如果不等于0则会产生居中偏移
    //v2.mySize = CGSizeMake(200, 35);   //效果和上面意义一致！
    v2.flexedHeight = YES;
    v2.sd_layout.widthIs(200).heightIs(35);
